...
use Mqpi\ChannelInterface;
use Mqpi\ConnectionInterface;
...
class AMQPChannel extends AbstractChannel implements ChannelInterface 
{
     ...
     * @throws \Exception
     */
    public function __construct(ConnectionInterface $connection, $channelId = null, $autoDecode = true)
    {
        if ($channelId == null) {
            $channelId = $connection->get_free_channel_id();
        }
        ...
        $this->debug->debug_msg('using channel_id: ' . $channelId);
