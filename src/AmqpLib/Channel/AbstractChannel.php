...
abstract class AbstractChannel
{
    ...
    {
        $this->debug->debug_allowed_methods($allowedMethods);

        $deferred = $this->process_deferred_methods($allowedMethods);
        ...
        while (true) {
            ...
            if ($this->should_dispatch_method($allowedMethods, $method_sig)) {
